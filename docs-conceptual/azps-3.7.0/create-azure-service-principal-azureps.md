...
## <a name="reset-credentials"></a><span data-ttu-id="6345c-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="6345c-173">Reset credentials</span></span>
