...
<span data-ttu-id="1c3b6-186">既存のプロファイル コマンドレットの変更</span><span class="sxs-lookup"><span data-stu-id="1c3b6-186">Changes to existing profile cmdlets</span></span>
