...
## <a name="manage-service-principal-roles"></a><span data-ttu-id="7b4e2-149">サービス プリンシパル ロールを管理する</span><span class="sxs-lookup"><span data-stu-id="7b4e2-149">Manage service principal roles</span></span>
