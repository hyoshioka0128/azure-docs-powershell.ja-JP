...
## <a name="reset-credentials"></a><span data-ttu-id="b8e75-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="b8e75-173">Reset credentials</span></span>
