...
## <a name="reset-credentials"></a><span data-ttu-id="e2bf4-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="e2bf4-173">Reset credentials</span></span>
