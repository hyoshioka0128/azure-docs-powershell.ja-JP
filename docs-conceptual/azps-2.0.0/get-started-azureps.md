...
* [<span data-ttu-id="4cc8f-161">Azure PowerShell を使用してサインインする</span><span class="sxs-lookup"><span data-stu-id="4cc8f-161">Sign in with Azure PowerShell</span></span>](authenticate-azureps.md)
