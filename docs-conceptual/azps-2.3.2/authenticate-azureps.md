...
## <a name="sign-in-interactively"></a><span data-ttu-id="55287-114">対話操作でサインインする</span><span class="sxs-lookup"><span data-stu-id="55287-114">Sign in interactively</span></span>
