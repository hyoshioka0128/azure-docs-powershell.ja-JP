...
<span data-ttu-id="81c94-186">既存のプロファイル コマンドレットの変更</span><span class="sxs-lookup"><span data-stu-id="81c94-186">Changes to existing profile cmdlets</span></span>
