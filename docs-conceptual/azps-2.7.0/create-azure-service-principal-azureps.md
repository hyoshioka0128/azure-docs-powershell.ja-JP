...
## <a name="reset-credentials"></a><span data-ttu-id="af662-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="af662-173">Reset credentials</span></span>
