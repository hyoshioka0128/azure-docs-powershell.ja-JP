...
<span data-ttu-id="b4c56-186">既存のプロファイル コマンドレットの変更</span><span class="sxs-lookup"><span data-stu-id="b4c56-186">Changes to existing profile cmdlets</span></span>
