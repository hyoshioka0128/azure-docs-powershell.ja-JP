...
<span data-ttu-id="fa3d6-186">既存のプロファイル コマンドレットの変更</span><span class="sxs-lookup"><span data-stu-id="fa3d6-186">Changes to existing profile cmdlets</span></span>
