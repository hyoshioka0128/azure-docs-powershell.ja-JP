...
<span data-ttu-id="9f277-186">既存のプロファイル コマンドレットの変更</span><span class="sxs-lookup"><span data-stu-id="9f277-186">Changes to existing profile cmdlets</span></span>
