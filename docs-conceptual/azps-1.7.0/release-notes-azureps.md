...
* `Get-AzResource` の結果をパイプ処理する際の問題を修正しました `Set-AzResource`
    - 詳細については、次を参照してください。 https://github.com/Azure/azure-powershell/issues/8240
* 実行時の JSON データ型の変更に関する問題を修正しました `Set-AzResource`
...
### <a name="azresources"></a>Az.Resources
* `New-AzureRmPolicyAssignment` のリソース ID 関連パラメーターに関するヘルプ ドキュメントを更新しました `Set-AzureRmPolicyAssignment`
