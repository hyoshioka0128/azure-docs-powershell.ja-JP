...
## <a name="manage-service-principal-roles"></a><span data-ttu-id="21cef-149">サービス プリンシパル ロールを管理する</span><span class="sxs-lookup"><span data-stu-id="21cef-149">Manage service principal roles</span></span>
