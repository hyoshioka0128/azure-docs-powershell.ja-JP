...
## <a name="manage-service-principal-roles"></a><span data-ttu-id="c636d-150">サービス プリンシパル ロールを管理する</span><span class="sxs-lookup"><span data-stu-id="c636d-150">Manage service principal roles</span></span>
