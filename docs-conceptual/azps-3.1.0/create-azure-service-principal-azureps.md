...
## <a name="reset-credentials"></a><span data-ttu-id="ef7dd-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="ef7dd-173">Reset credentials</span></span>
