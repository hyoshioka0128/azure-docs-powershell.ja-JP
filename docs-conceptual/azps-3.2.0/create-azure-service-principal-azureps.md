...
## <a name="reset-credentials"></a><span data-ttu-id="c7621-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="c7621-173">Reset credentials</span></span>
