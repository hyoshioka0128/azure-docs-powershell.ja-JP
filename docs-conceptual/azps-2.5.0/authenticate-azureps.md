...
## <a name="sign-in-interactively"></a><span data-ttu-id="4028c-114">対話操作でサインインする</span><span class="sxs-lookup"><span data-stu-id="4028c-114">Sign in interactively</span></span>
