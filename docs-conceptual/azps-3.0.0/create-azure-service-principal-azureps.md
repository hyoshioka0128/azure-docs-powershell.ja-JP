...
## <a name="reset-credentials"></a><span data-ttu-id="9ffda-173">資格情報をリセットする</span><span class="sxs-lookup"><span data-stu-id="9ffda-173">Reset credentials</span></span>
